...
const InactiveMembers = ({ members }: { members: MemberSchemaType[] }) => {
    ...
    return (
        <div>
            <Breadcrumbs>
                ...
                <BreadcrumbItem className="text-primary">Inactive Members </BreadcrumbItem>
            </Breadcrumbs>
            <div className="mt-5">
                <Card>
                    <CardHeader className="flex flex-row justify-between items-center py-2">
                        <CardTitle>Inactive Members <span className="text-warning font-bold">({members?.length})</span></CardTitle>
                        <AddMemberModel />
                    </CardHeader>
