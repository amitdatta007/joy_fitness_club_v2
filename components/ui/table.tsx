...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-14 px-4  text-left last:text-right align-middle font-semibold  text-sm  text-default-800    capitalize  [&:has([role=checkbox])]:pr-0 ",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-4 align-middle  text-sm text-default-600 last:text-right  font-normal  [&:has([role=checkbox])]:pr-0 ",
      className
    )}
    {...props}
  />
